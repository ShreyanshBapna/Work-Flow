...
export function EditCardEmployee({open, onClose, contentId}: {open: boolean, onClose: () => void, contentId: string}) {
    ...
    async function editContent(){
        ...
        const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/employee/${contentId}`, {
            name,
            email,
            role,   
            department,
                ...
                <div className="bg-gradient-to-r from-white via-white/80 to-rose-50 rounded-2xl p-10 shadow-lg flex items-center justify-center gap-30">
                    ...
                    <div className="bg-white p-6 rounded-2xl">
                        ...
                        <div className="flex mt-7 ">
                            <div className="mr-2">     
                                <Button onClick={() => { editContent()}} heading="Edit Employee"/>
                            </div>
                            <div>
